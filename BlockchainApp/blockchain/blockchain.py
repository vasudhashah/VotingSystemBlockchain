...
from BlockchainApp.config import MINING_REWARD_INPUT
...
class Blockchain:
    ...
    def replace_chain(self, chain):
        ...
        Replace the local chain with the incoming one if the following applies:
            -The incoming chain must be larger than local one.
            -The incoming chain must be properly formatted.
        '''
    ...
    def to_json(self):
        '''
        to serialize blockchain into a list of blocks.
        '''
        '''
        serialized_chain = []
    ...
    def is_valid_transaction_chain(chain):
        ...
        Enforce the rules of a chain composed of blocks of transactions.
            -Each transaction must appear once in a chain.
